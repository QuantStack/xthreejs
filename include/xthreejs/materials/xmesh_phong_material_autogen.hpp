...
namespace xthree
{
    ...
    public:
        ...
        XPROPERTY(std::string, derived_type, type, "MeshPhongMaterial");
...
xeus::xjson mime_bundle_repr(xw::xmaterialize<xthree::xmesh_phong_material>& widget);
 ...
 *********************/
    ...
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xmesh_phong_material>;
        extern template xw::xmaterialize<xthree::xmesh_phong_material>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xmesh_phong_material>>;
        extern template class xw::xgenerator<xthree::xmesh_phong_material>;
        extern template xw::xgenerator<xthree::xmesh_phong_material>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xmesh_phong_material>>;
    #endif
#endif
