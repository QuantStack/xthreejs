...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xwebgl_program>& widget)
    {
        if (not widget.pre)
...
#ifdef PRECOMPILED
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xwebgl_program>;
        extern template xw::xmaterialize<xthree::xwebgl_program>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xwebgl_program>>;
        extern template class xw::xgenerator<xthree::xwebgl_program>;
        extern template xw::xgenerator<xthree::xwebgl_program>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xwebgl_program>>;
    #endif
#endif
