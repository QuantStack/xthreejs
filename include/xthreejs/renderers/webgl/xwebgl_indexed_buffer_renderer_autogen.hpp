...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xwebgl_indexed_buffer_renderer>& widget)
    {
        if (not widget.pre)
...
#ifdef PRECOMPILED
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xwebgl_indexed_buffer_renderer>;
        extern template xw::xmaterialize<xthree::xwebgl_indexed_buffer_renderer>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xwebgl_indexed_buffer_renderer>>;
        extern template class xw::xgenerator<xthree::xwebgl_indexed_buffer_renderer>;
        extern template xw::xgenerator<xthree::xwebgl_indexed_buffer_renderer>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xwebgl_indexed_buffer_renderer>>;
    #endif
#endif
