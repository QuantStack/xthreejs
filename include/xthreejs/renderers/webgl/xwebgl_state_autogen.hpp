...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xwebgl_state>& widget)
    {
        if (not widget.pre)
...
#ifdef PRECOMPILED
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xwebgl_state>;
        extern template xw::xmaterialize<xthree::xwebgl_state>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xwebgl_state>>;
        extern template class xw::xgenerator<xthree::xwebgl_state>;
        extern template xw::xgenerator<xthree::xwebgl_state>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xwebgl_state>>;
    #endif
#endif
