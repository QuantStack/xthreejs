...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xline_curve>& widget)
    {
        if (not widget.pre)
...
#ifdef PRECOMPILED
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xline_curve>;
        extern template xw::xmaterialize<xthree::xline_curve>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xline_curve>>;
        extern template class xw::xgenerator<xthree::xline_curve>;
        extern template xw::xgenerator<xthree::xline_curve>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xline_curve>>;
    #endif
#endif
