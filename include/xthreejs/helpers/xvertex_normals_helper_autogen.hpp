...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xvertex_normals_helper>& widget)
    {
        if (not widget.pre)
 ...
 *********************/
        ...
        extern template xw::xmaterialize<xthree::xvertex_normals_helper>::xmaterialize();
        ...
        extern template xw::xgenerator<xthree::xvertex_normals_helper>::xgenerator();
