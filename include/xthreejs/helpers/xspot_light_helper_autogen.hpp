...
namespace xthree
{
    ...
    public:
        ...
        XPROPERTY(std::string, derived_type, type, "SpotLightHelper");
...
xeus::xjson mime_bundle_repr(xw::xmaterialize<xthree::xspot_light_helper>& widget);
 ...
 *********************/
    ...
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xspot_light_helper>;
        extern template xw::xmaterialize<xthree::xspot_light_helper>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xspot_light_helper>>;
        extern template class xw::xgenerator<xthree::xspot_light_helper>;
        extern template xw::xgenerator<xthree::xspot_light_helper>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xspot_light_helper>>;
    #endif
#endif
