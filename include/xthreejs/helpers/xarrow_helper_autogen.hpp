...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xarrow_helper>& widget)
    {
        if (not widget.pre)
 ...
 *********************/
        ...
        extern template xw::xmaterialize<xthree::xarrow_helper>::xmaterialize();
        ...
        extern template xw::xgenerator<xthree::xarrow_helper>::xgenerator();
