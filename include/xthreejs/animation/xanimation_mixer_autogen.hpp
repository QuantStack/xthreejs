...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xanimation_mixer>& widget)
    {
        if (not widget.pre)
 ...
 *********************/
        ...
        extern template xw::xmaterialize<xthree::xanimation_mixer>::xmaterialize();
        ...
        extern template xw::xgenerator<xthree::xanimation_mixer>::xgenerator();
