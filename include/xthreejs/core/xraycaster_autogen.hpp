...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xraycaster>& widget)
    {
        if (not widget.pre)
 ...
 *********************/
        ...
        extern template xw::xmaterialize<xthree::xraycaster>::xmaterialize();
        ...
        extern template xw::xgenerator<xthree::xraycaster>::xgenerator();
