...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xcube_texture>& widget)
    {
        if (not widget.pre)
 ...
 *********************/
        ...
        extern template xw::xmaterialize<xthree::xcube_texture>::xmaterialize();
        ...
        extern template xw::xgenerator<xthree::xcube_texture>::xgenerator();
