...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xfont_loader>& widget)
    {
        if (not widget.pre)
 ...
 *********************/
        ...
        extern template xw::xmaterialize<xthree::xfont_loader>::xmaterialize();
        ...
        extern template xw::xgenerator<xthree::xfont_loader>::xgenerator();
