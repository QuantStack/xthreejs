...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xorbit_controls>& widget)
    {
        if (not widget.pre)
...
#ifdef PRECOMPILED
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xorbit_controls>;
        extern template xw::xmaterialize<xthree::xorbit_controls>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xorbit_controls>>;
        extern template class xw::xgenerator<xthree::xorbit_controls>;
        extern template xw::xgenerator<xthree::xorbit_controls>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xorbit_controls>>;
    #endif
#endif
