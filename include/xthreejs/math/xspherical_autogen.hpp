...
namespace xthree
{
    ...
    xeus::xjson mime_bundle_repr(xw::xmaterialize<xspherical>& widget)
    {
        if (not widget.pre)
...
#ifdef PRECOMPILED
    #ifndef _WIN32
        extern template class xw::xmaterialize<xthree::xspherical>;
        extern template xw::xmaterialize<xthree::xspherical>::xmaterialize();
        extern template class xw::xtransport<xw::xmaterialize<xthree::xspherical>>;
        extern template class xw::xgenerator<xthree::xspherical>;
        extern template xw::xgenerator<xthree::xspherical>::xgenerator();
        extern template class xw::xtransport<xw::xgenerator<xthree::xspherical>>;
    #endif
#endif
